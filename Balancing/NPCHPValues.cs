...
namespace InfernumMode.Balancing
{
    public static class NPCHPValues
    {
        public static Dictionary<int, int> HPValues => new Dictionary<int, int>()
        {
            ...
            [ModContent.NPCType<ProfanedGuardianBoss2>()] = BossRushEvent.BossRushActive ? 205000 : 80000,
            [ModContent.NPCType<ProfanedGuardianBoss3>()] = BossRushEvent.BossRushActive ? 205000 : 80000,
