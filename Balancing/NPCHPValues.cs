...
namespace InfernumMode.Balancing
{
    public static class NPCHPValues
    {
        public static Dictionary<int, int> HPValues => new Dictionary<int, int>()
        {
            ...
            [ModContent.NPCType<AstrumDeusHeadSpectral>()] = BossRushEvent.BossRushActive ? 930000 : 287000,
            ...
            [ModContent.NPCType<ProfanedGuardianBoss>()] = BossRushEvent.BossRushActive ? 620000 : 132000,
            [ModContent.NPCType<ProfanedGuardianBoss2>()] = BossRushEvent.BossRushActive ? 205000 : 56000,
            [ModContent.NPCType<ProfanedGuardianBoss3>()] = BossRushEvent.BossRushActive ? 205000 : 56000,
