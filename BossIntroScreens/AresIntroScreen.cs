...
namespace InfernumMode.BossIntroScreens
{
    public class AresIntroScreen : BaseIntroScreen
    {
        ...
        public override string TextToDisplay => "The Ultimate War Machine\nAres";	
        ...
        public override void PrepareShader(Effect shader)
        {
            ...
            shader.GraphicsDevice.Textures[1] = ModContent.GetTexture("CalamityMod/ExtraTextures/EternityStreak");
        }
