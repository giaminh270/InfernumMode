...
namespace InfernumMode.BehaviorOverrides.BossAIs.SupremeCalamitas
{
    public class SupremeCataclysmBehaviorOverride : NPCBehaviorOverride
    {
        ...
        public static void DoBehavior_AttackDelay(NPC npc, Player target, bool isCataclysm, ref float currentFrame, ref float attackTimer)
        {
            ...
            // Fade in.
            npc.Opacity = Utils.InverseLerp(0f, 24f, attackTimer, true);
        ...
        public static void DoBehavior_Hyperdashes(NPC npc, Player target, bool isCataclysm, ref float attackSpecificTimer, ref float currentFrame, ref float firingFromRight, ref float attackTimer)
        {
            ...
            npc.localAI[2] = Utils.InverseLerp(0f, chargeTelegraphTime - 8f, wrappedAttackTimer, true) * Utils.InverseLerp(-16f, -1f, wrappedAttackTimer - chargeTelegraphTime - chargeTime, true);
        ...
        public static void SelectNextAttack(NPC npc)
        {
			...
			switch ((int)npc.ai[0])
			{
				case (int)SCalBrotherAttackType.SinusoidalBobbing:
				case (int)SCalBrotherAttackType.AttackDelay:
					npc.ai[0] = (int)SCalBrotherAttackType.Hyperdashes;
					break;
				case (int)SCalBrotherAttackType.Hyperdashes:
					npc.ai[0] = (int)SCalBrotherAttackType.ProjectileShooting;
					break;
				default:
					npc.ai[0] = (int)SCalBrotherAttackType.SinusoidalBobbing;
					break;
			}
            npc.ai[1] = 0f;
            for (int i = 0; i < 6; i++)
