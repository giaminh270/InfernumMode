...
namespace InfernumMode.BehaviorOverrides.BossAIs.SupremeCalamitas
{
    public class SepulcherBody1BehaviorOverride : NPCBehaviorOverride
    {
        ...
        public static void DoSetDefaults(NPC npc)
        {
            ...
            if (npc.type == ModContent.NPCType<SCalWormBodyWeak>())
            ...
            npc.HitSound = SoundID.DD2_SkeletonHurt.WithVolume(0.925f);
        ...
        public static bool DoAI(NPC npc)
        {
            ...
            if (npc.type == ModContent.NPCType<SCalWormBodyWeak>() && (attackType == SepulcherAttackType.SoulBombBursts || attackType == SepulcherAttackType.ErraticCharges))
                npc.ModNPC<SCalWormBodyWeak>().AttackTimer = 0f;
    ...
    {
        public override int NPCOverrideType => ModContent.NPCType<SCalWormBodyWeak>();
