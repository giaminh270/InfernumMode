...
namespace InfernumMode.BehaviorOverrides.BossAIs.SupremeCalamitas
{
    ...
    {
        public static List<TimeSpan> Grief_HighPoints => new List<TimeSpan>()
        {
        ...
        public static List<TimeSpan> Lament_HighPoints => new List<TimeSpan>()
        {
        ...
        public static Dictionary<TimeSpan, float> Epiphany_HighPoints => new Dictionary<TimeSpan, float>()
        {
            // The end...
