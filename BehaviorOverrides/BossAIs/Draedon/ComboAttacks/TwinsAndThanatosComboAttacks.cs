        ...
        public static bool UseTwinsThanatosComboAttack(NPC npc, float twinsHoverSide, ref float attackTimer, ref float frameType)
        {
			...
			switch ((ExoMechComboAttackType)initialMech.ai[0])
			{
				case ExoMechComboAttackType.TwinsThanatos_ThermoplasmaDashes:
					return DoBehavior_TwinsThanatos_ThermoplasmaDashes(npc, target, ref attackTimer, ref frameType);
				
				case ExoMechComboAttackType.TwinsThanatos_CircledLaserSweep:
					return DoBehavior_TwinsThanatos_CircledLaserSweep(npc, target, ref attackTimer, ref frameType);
