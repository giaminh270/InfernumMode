...
namespace InfernumMode.BehaviorOverrides.BossAIs.Providence
{
    public class ProfanedRocksBehaviorOverride : NPCBehaviorOverride
    {
        ...
        public override bool PreAI(NPC npc)
        {
            ...
            npc.Opacity = Utils.InverseLerp(1180f, 1000f, offsetRadius, true);
            ...
            {
                float incrementalRadiusChange = Utilities.Remap(offsetRadius - idealRadius, 120f, 640f, 3f, 12f);
        ...
        public override bool PreDraw(NPC npc, SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D texture = ModContent.GetTexture($"InfernumMode/BehaviorOverrides/BossAIs/Providence/ProfanedRocks/{rockVariantName}");
            if (ProvidenceBehaviorOverride.IsEnraged)
            {
                rockVariantName = $"ProfanedRocksNight{npcType}";
                texture = ModContent.GetTexture($"InfernumMode/BehaviorOverrides/BossAIs/Providence/ProfanedRocks/{rockVariantName}");
            }
            ...
            npc.DrawBackglow(Color.White * 1f, 4f, SpriteEffects.None, frame, Main.screenPosition, texture);
