...
namespace InfernumMode.BehaviorOverrides.BossAIs.AquaticScourge
{
    public class AquaticScourgeHeadBehaviorOverride : NPCBehaviorOverride
    {
        ...
        public static void DoBehavior_ProjectileSpin(NPC npc, float attackTimer, ref float speedFactor)
        {
            ...
            speedFactor = Utils.InverseLerp(redirectTime, 0f, attackTimer, true);
        ...
        public static void DoMovement_AggressiveSnakeMovement(NPC npc, Player target, float generalTimer, float speedFactor)
        {
            ...
            float acceleration = MathHelper.Lerp(0.023f, 0.0285f, Utils.InverseLerp(1f, Phase5LifeRatio, lifeRatio, true));
            float movementSpeed = MathHelper.Lerp(10.5f, 14f, Utils.InverseLerp(1f, Phase5LifeRatio, lifeRatio, true));
        ...
        public static void DoMovement_GeneralMovement(NPC npc, Player target, float speedFactor)
        {
            ...
            float lifeRatio = npc.life / (float)npc.lifeMax;
            float idealRotation = npc.AngleTo(target.Center);
            float acceleration = MathHelper.Lerp(0.019f, 0.0265f, Utils.InverseLerp(1f, Phase5LifeRatio, lifeRatio, true));
            float movementSpeed = MathHelper.Lerp(12.25f, 14.25f, Utils.InverseLerp(1f, Phase5LifeRatio, lifeRatio, true));
            movementSpeed += MathHelper.Lerp(0f, 15f, Utils.InverseLerp(420f, 3000f, npc.Distance(target.Center), true));
