...
namespace InfernumMode.BehaviorOverrides.BossAIs.DukeFishron
{
    public class DukeFishronBehaviorOverride : NPCBehaviorOverride
    {
        ...
        public static Dictionary<DukeAttackType[], Func<NPC, bool>> SubphaseTable => new Dictionary<DukeAttackType[], Func<NPC, bool>>()
        {
            ...
            [Subphase2Pattern] = (npc) => npc.life / (float)npc.lifeMax < Phase2LifeRatio && npc.life >= Phase3LifeRatio,
            [Subphase3Pattern] = (npc) => npc.life / (float)npc.lifeMax < Phase3LifeRatio && npc.life >= Phase4LifeRatio,
        ...
        public override bool PreAI(NPC npc)
        {
            ...
            if (attackDelay < 60f)
            {
                ...
                if (attackDelay == 30f)
                    Main.PlaySound(SoundID.Zombie, npc.Center, 20);
        ...
        public static void DoBehavior_BubbleSpit(NPC npc, Player target, Vector2 mouthPosition, ref float attackTimer, ref float frameDrawType, bool inPhase3, bool inPhase4, bool enraged)
        {
            ...
            {
                Main.PlaySound(SoundID.NPCKilled, npc.Center, 19);
