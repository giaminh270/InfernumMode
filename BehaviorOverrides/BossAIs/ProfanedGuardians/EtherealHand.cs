...
namespace InfernumMode.BehaviorOverrides.BossAIs.ProfanedGuardians
{
    public class EtherealHand : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            destination += new Vector2((float)HandSide * 120f, (float)Math.Sin(Main.GlobalTime * 3f + (float)HandSide * 2.1f) * 30f - 80f);
            ...
            float hoverSpeed = Math.Min((AttackerGuardian.position - AttackerGuardian.oldPos[1]).Length() * 1.25f + 8f, npc.Distance(destination));
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
        {
            ...
            sagLocation.Y += MathHelper.Lerp(0f, 30f, Utils.InverseLerp(4f, 1f, Math.Abs(AttackerGuardian.velocity.Y + 0.1f), true));
