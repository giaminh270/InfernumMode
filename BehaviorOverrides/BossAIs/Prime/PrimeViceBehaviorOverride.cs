    ...
    public class PrimeViceBehaviorOverride : PrimeHandBehaviorOverride
    {
        ...
        public static void DoBehavior_SlowSparkShrapnelMeleeCharges(NPC npc, Player target)
        {
            ...
            if (attackSubstate == 0f)
            {
                ...
                npc.Center = Vector2.Lerp(npc.Center, new Vector2(head.Center.X, npc.Center.Y), 0.1f);
            ...
            else
            {
                ...
                if (Main.rand.NextBool(3))
                {
                    ...
                    SparkParticle spark = new SparkParticle(npc.Center, npc.velocity.RotatedByRandom(0.78f) * Main.rand.NextFloat(1.3f, 2f), 36, 0.9f, sparkColor);
                ...
                float volumeInterpolant = Utils.InverseLerp(195f, 150f, localTimer, true);
                ...
                {
                    var soundInstance = Main.PlaySound(InfernumSoundRegistry.PrimeSawSound, npc.Center);
                }
            }
