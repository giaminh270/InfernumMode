    ...
    public class SpikeTrap : ModProjectile
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            if (frameHeight > 0f)
            {
                ...
                spriteBatch.Draw(Main.chain17Texture, spikeTip - Main.screenPosition, spikeFrame, spikeColor, spikeRotation, new Vector2(Main.chain17Texture.Width / 2f, 0f), 1f, 0, 0f);
