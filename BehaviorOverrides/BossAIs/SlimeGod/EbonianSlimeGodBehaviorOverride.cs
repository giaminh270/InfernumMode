...
namespace InfernumMode.BehaviorOverrides.BossAIs.SlimeGod
{
    public class EbonianSlimeGodBehaviorOverride : NPCBehaviorOverride
    {
        ...
        public override bool PreAI(NPC npc)
        {
            ...
            {
                int secondSlime = NPC.NewNPC((int)target.Center.X, (int)target.Center.Y - 750, ModContent.NPCType<SlimeGodRun>(), npc.whoAmI, 0f, 0f, SlimeGodComboAttackManager.DelayBeforeSoloEnrageAttacksBegin);
