    ...
    public class JewelBehaviorOverride : NPCBehaviorOverride
    {
        ...
        public override bool PreAI(NPC npc)
        {
            ...
            if (attackTimer % shootRate >= shootRate * 0.5f)
            {
                ...
                backglowInterpolant = CalamityUtils.Convert01To010(Utils.InverseLerp(shootRate * 0.5f, shootRate, attackTimer % shootRate, true));
            }
        ...
        public override bool PreDraw(NPC npc, SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            if (backglowInterpolant > 0.001f)
            {
                for (int i = 0; i < 12; i++)
                {
                    ...
                    Main.spriteBatch.Draw(texture, drawPosition + drawOffset, npc.frame, npc.GetAlpha(Color.White), npc.rotation, npc.frame.Size() * 0.5f, npc.scale, 0, 0f);
                }
            }
