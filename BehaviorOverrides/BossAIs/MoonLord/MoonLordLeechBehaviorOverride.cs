...
namespace InfernumMode.BehaviorOverrides.BossAIs.MoonLord
{
    public class MoonLordLeechBehaviorOverride : ProjectileBehaviorOverride
    {
        ...
        public override bool PreDraw(Projectile projectile, SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Point tileCoords = drawPosition.ToTileCoordinates();
            if (remainingDistance > 0f)
            {
                ...
                while (movedDistance + 1f < remainingDistance)
                {
                    ...
                    Color c = Color.Lerp(Lighting.GetColor(tileCoords.X, tileCoords.Y), Color.White, 0.3f);
            ...
            Color color = Color.Lerp(Lighting.GetColor(tileCoords.X, tileCoords.Y), Color.White, 0.3f);
