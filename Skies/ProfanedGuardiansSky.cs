...
namespace InfernumMode.Skies
{
    public class ProfanedGuardiansSky : CustomSky
    {
        public class Symbol
        {
            ...
            public Rectangle Frame => new Rectangle(0, Varient * 30, 50, 30);
		...
		private static float MaxIntensity
		{
			get
			{
				int remaining = AttackerGuardianBehaviorOverride.TotalRemaininGuardians;
				switch (remaining)
				{
					case 3:
						return 0.05f;
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (NPC.FindFirstNPC(ModContent.NPCType<ProfanedGuardianBoss>()) == -1)
                    Deactivate();
        }
        ...
        public override void Draw(SpriteBatch spriteBatch, float minDepth, float maxDepth)
        {
            ...
            {
                Texture2D skyTexture = ModContent.GetTexture("InfernumMode/Skies/ProfanedGuardiansSky");
            ...
            Texture2D symbolTexture = ModContent.GetTexture("InfernumMode/Skies/ProfanedSymbols");
            ...
            for (int i = 0; i < Symbols.Count; i++)
            {
                ...
                {
                    Vector2 scale = new Vector2(1f / symbol.Depth, 1f / symbol.Depth);
                    ...
                    if (rectangle.Contains((int)position.X, (int)position.Y))
                    {
                        ...
                        spriteBatch.Draw(symbolTexture, position, symbol.Frame, lightColor, 0f, origin, scale * symbol.Opacity, 0, 0f);
                    }
                }
            }
        }
